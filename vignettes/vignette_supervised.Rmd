...
loadingplot(so.pot, ncomp = c(4,3), comps = c(2,3), block = 1, scatter = TRUE, main = "Block 1")
loadingplot(so.pot, ncomp = c(4,3), block = 2, scatter = TRUE, main = "Block 2")
par(old.par)
```
...
old.par <- par("mfrow"); on.exit(par(old.par)); par(mfrow=c(1,2))
scoreplot(so.pot, ncomp = c(4,3), comps = c(2,3), block = 1, main = "Block 1")
scoreplot(so.pot, ncomp = c(4,3), block = 2, main = "Block 2")
par(old.par)
```
